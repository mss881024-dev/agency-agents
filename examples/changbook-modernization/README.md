...
| Visual system | [UI Designer](../../design/design-ui-designer.md) | Ink-and-hanji palette (warm paper, sumi ink, celadon accent, vermilion seal-stamp red) instead of the generic cream/terracotta/purple-gradient defaults — grounded in the actual product mix (calligraphy books, classical texts, seal-stamp tradition). Genre-tinted card spines double as a lightweight taxonomy the original site never had. |
